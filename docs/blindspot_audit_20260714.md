...
> **2026-07-16 收尾增量**：`tool11_hazardwise` 统一过滤 `fallback_used`、`mock`、`debug_fallback`、`mock_fallback`、`fallback` 和 `local_vlm_fallback` 来源，避免低证据 hazard 行进入加权汇总；全量回归测试为 383 passed。
